...
| datasource.url | string | `"jdbc:postgresql://localhost/kurs"` | URL für den DB-Zugriff |
| datasource.username | string | `"kurs"` | Benutzername für das DB-System |
...
| image.name | string | `"kurs"` | Name des Image |
