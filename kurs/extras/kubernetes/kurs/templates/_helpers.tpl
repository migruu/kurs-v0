...
*/}}
{{- define "kurs.labels" -}}
helm.sh/chart: {{ include "kurs.chart" . }}
{{ include "kurs.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kurs.selectorLabels" -}}
app: {{ include "kurs.name" . }}
app.kubernetes.io/name: {{ include "kurs.name" . }}
